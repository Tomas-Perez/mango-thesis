...
An example of offloaded OpenMP code can be seen in listing \ref{lst:openmp_saxpy}. The code looks like a regular serial implementation of SAXPY, except for the two \texttt{\#pragma}s. Very similar code can be achieved with OpenACC.

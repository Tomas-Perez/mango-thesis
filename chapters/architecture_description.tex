...
% TODO: emphasize more the distributed nature of HHAL
...
Giving developers the ability to work directly with kernel source code greatly facilitates the development process. Ideally, once a solution is in place, kernels would be pre-compiled for optimal performance. % TODO: Actually a good point of JIT is that we can apply some optimizations at runtime.
...
% TODO: requires input and output buffers because of its passive nature? 
